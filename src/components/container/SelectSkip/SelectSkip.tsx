...
import SkipList from "../../presentational/SkipList/SkipList";
...
const SelectSkip = (): JSX.Element => {
  const [selectedSkipId, setSelectedSkipId] = useState<number | null>(null);

  return (
    <div className={styles.wrapper}>
      <Text content={"Takis"} type="span" fw={600} />

      <Text content={"Takis"} type="span" fw={600} />

      <SkipList
        skips={items.sort((a, b) => a.size - b.size)}
